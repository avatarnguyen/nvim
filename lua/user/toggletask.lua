...
-- Autocommand for .arb save actions
toggletasks.auto_spawn({ 'BufWritePost' }, function(tasks)
  return tasks
      :with_tag('ota')
      :from_file('/Users/anhknowunity/Developer/.toggletasks')
      :name_matches("*.arb")
end)
