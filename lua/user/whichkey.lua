...
local mappings = {
  ...
  d = {
    name = "Flutter",
    n = { "<cmd>!tmux send-keys -t flutter 'fr' Enter<CR><CR>", "Tmux: Run" },
    j = { "<cmd>!tmux send-keys -t flutter 'frd' Enter<CR><CR>", "Tmux: Run Samsung Devices" },
    r = { "<cmd>!tmux send-keys -t flutter 'R'<CR>", "Tmux: Restart" },
